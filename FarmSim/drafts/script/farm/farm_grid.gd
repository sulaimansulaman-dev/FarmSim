...
func _try_plant(crop: DraftCrop, crop_id: String, index: int) -> void:
...
func _try_harvest(crop: DraftCrop, index: int) -> void:
...
func _tile_text(crop: DraftCrop) -> String:
	match crop.state:
...
func _tile_colour(crop: DraftCrop) -> Color:
	match crop.state:
		DraftCrop.State.EMPTY, DraftCrop.State.HARVESTED:
